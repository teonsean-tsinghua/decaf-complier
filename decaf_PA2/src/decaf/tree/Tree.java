...
public abstract class Tree {
    ...
    public static final int AT = NOT + 1;
    public static final int DOLLAR = AT + 1;
    public static final int SHARP = DOLLAR + 1;
    public static final int COMPL = SHARP + 1;
    ...
    public static final int DCOPYEXPR = CALLEXPR + 1;
    public static final int SCOPYEXPR = DCOPYEXPR + 1;
    public static final int THISEXPR = SCOPYEXPR + 1;
    ...
    public static final int CASEEXPR = READLINEEXPR + 1;
    public static final int CASEBLOCK = CASEEXPR + 1;
    public static final int PRINT = CASEBLOCK + 1;
    ...
    public static final int IMGPART = COMPLEX + 1;
    ...
    public static class DoStmt extends Tree {
    	...
    	public List<DoSubStmt> branches;
    	
    	public DoStmt(DoSubStmt stmt, List<DoSubStmt> branches, Location loc) {
    		super(DOSTMT, loc);
    ...
    public static class CaseExpr extends Expr {
    	...
    	public CaseExpr(Literal constant, Expr expr, Location loc) {
    		super(CASEEXPR, loc);
    ...
    public static class CaseBlock extends Expr {
    	public Expr mainExpr;
    	public List<CaseExpr> caseExprs;
    	public Expr defaultExpr;
    	
    	public CaseBlock(Expr mainExpr, List<CaseExpr> caseExprs,
    			Expr defaultExpr, Location loc) {
    		super(CASEBLOCK, loc);
